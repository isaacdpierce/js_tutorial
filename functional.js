...
function imperativeMap(states) {
  ...
  states.forEach(function(state) {
    ...
    // Change to incorporate urlify function
...
// reduce: eg.1 - Iterative solution
...
// reduce object: eg.2 - Functional solution
